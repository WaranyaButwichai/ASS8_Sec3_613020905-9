...
class MainActivity : AppCompatActivity() {
    ...
    fun callEmployeedata(){
        ...
        serv.retrieveStudent()
            .enqueue(object : Callback<List<Employees>> {
                override fun onResponse(
                    call: Call<List<Employees>>,
                    response: Response<List<Employees>>
                ) {
                    response.body()?.forEach{
                        employeeList.add(Employees(it.emp_name,it.emp_gender,it.emp_email,it.emp_salary))
                    }
    ...
    fun addEmployee2(view: View) {
        ...
        serv.insertStd(
            ...
            gender,
            mail,
            salary).enqueue(object :Callback<Employees>{
